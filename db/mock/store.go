...
// Source: github.com/kharljhon14/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateTransaction(arg0 context.Context, arg1 db.CreateTransactionParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransaction(arg0 context.Context, arg1 int64) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransactions(arg0 context.Context, arg1 db.ListTransactionsParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
